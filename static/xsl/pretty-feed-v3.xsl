    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body>
        <nav class="intro">
          <div class="container">
            <div>
              <p><strong>Heeeey, good work! You found me!</strong> This is my humble RSS feed. You can <strong>Subscribe</strong> by copy-pasting the URL into your RSS feed reader.</p>
              <small>
